		...
		<div class="card">
			...
			<div class="card-body">
				...
				<input type="hidden" id="courseId" name="courseId"
					...
					onclick="f(${c.getCourseId()}, '${c.getCourseName()}', '${c.getCoursePrice()}', '${c.getCourseDuration()}', '${c.getCourseAuthor()}', '${c.getCourseDescription()}', '${c.getTotalSubCourse()}', '${c.getImageUrl()}' )">Update</a> <a
					href="<%=request.getContextPath()%>/AdminController/deleteCourse?id=${ c.getCourseId()}&amp;coid=${c.getCategoryId()}"
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form id="updateCourseForm"
						...
						method="post">
						<input type="text"
							id="catid" name="catId" readonly="readonly"><br>
